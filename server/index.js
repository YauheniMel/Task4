...
router.post('https://task-deploy-5.herokuapp.com/api/users', timeout, (req, res) => {
...
router.put('https://task-deploy-5.herokuapp.com/api/login', timeout, async (req, res) => {
...
// eslint-disable-next-line consistent-return
router.put('https://task-deploy-5.herokuapp.com/api/block', timeout, (req, res) => {
  let command;
...
// eslint-disable-next-line consistent-return
router.put('https://task-deploy-5.herokuapp.com/api/unblock', timeout, (req, res) => {
...
router.post('https://task-deploy-5.herokuapp.com/api/register', timeout, (req, res) => {
  try {
    // eslint-disable-next-line consistent-return
    connection.query('SELECT * FROM users', (err, results) => {
      if (err) throw new Error(err);
...
router.delete('https://task-deploy-5.herokuapp.com/api/del/:ids', timeout, (req, res) => {
  let command;
...
router.post('https://task-deploy-5.herokuapp.com/api/logout', timeout, (req, res) => {
  const { id } = req.body;
